// OntoMaton is a component of the ISA software suite (http://www.isa-agents.org)
//
// License:
...
// Graphic Image provided in the Covered Code as file: http://isatab.sf.net/assets/img/agents/ontomaton-part-of-isaagents.png
